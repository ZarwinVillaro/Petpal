...
class ResourcesTest < ApplicationSystemTestCase
  ...
  test "should create resource" do
    ...
    fill_in "Generate", with: @resource.generate
    fill_in "Name", with: @resource.name
    fill_in "Published at", with: @resource.published_at
    fill_in "Rails", with: @resource.rails
    fill_in "Scaffold", with: @resource.scaffold
